                ...
                {FORMATS.map((f) => (
                  <label key={f.id} className={chipClass}>
                    <input
                      ...
                      name="formats"
                      value={f.id}
                      defaultChecked={f.id === initialFormat}
                      className="sr-only"
                    />
                    {f.label}
                  </label>
        ...
        <aside className="side-sticky flex flex-col gap-4">
          <section className="panel flex flex-col gap-2.5 px-4 py-3.5">
            ...
            <p className="m-0 text-[13px] text-muted">
              Eight concepts, each with a hook, a persuasion angle,
              platform-ready copy, a visual direction and — for video and UGC —
              a scene-by-scene script. Pick the ones you like and make the ad.
            </p>
          </section>
          <section className="panel flex flex-col gap-2.5 px-4 py-3.5">
          ...
          <section className="flex flex-col gap-2 px-0.5 py-1">
            ...
            <ul className="m-0 flex list-none flex-col gap-1.5 p-0 text-[12px] text-[#4a4b44]">
              ...
              <li>
                Constraints beat adjectives: &ldquo;no before/after
                photos&rdquo; is better than &ldquo;tasteful&rdquo;.
              </li>
            </ul>
          </section>
        </aside>
