...
export type LookPack = {
  ...
  kind: LookPackKind;
  description: string;
  /** Three swatches that stand in for a preview (HeyGen exposes no pack thumbnails over the API). */
...
export const LOOK_PACKS: LookPack[] = [
  { id: "modern-corporate", name: "Modern Corporate", kind: "style", description: "Tailored blazers, crisp shirts and a neutral studio — the boardroom-ready set.", palette: ["#1f2a3a", "#c9d1dc", "#f3f1ec"], templates: { female: "5a8e6be843ee4321a014946bf62aa322", male: "5e659e76755d47fd9160a2d7dedce124" }, looks: 5, type: "look_pack" },
  { id: "stylish-business-casual", name: "Stylish Business-Casual", kind: "style", description: "Knits, open collars and relaxed layers; approachable but still polished.", palette: ["#6b5b4a", "#d9c7ae", "#eee9df"], templates: { female: "e1650a9029d04ea1a350421c163295fd", male: "a5f8e0c0cb654c1a83c695629b173af5" }, looks: 5, type: "look_pack" },
  { id: "scandinavian-minimal", name: "Scandinavian Minimal", kind: "style", description: "Muted tones, clean lines, soft daylight — calm and considered.", palette: ["#9a9d96", "#dcdad2", "#f7f6f2"], templates: { female: "e7b000e2cb0d44f1a2d2f291a38b395a", male: "9600f78f27bb49d792e1c56ce624b929" }, looks: 5, type: "look_pack" },
  { id: "cool-tech-slate", name: "Cool Tech / Slate", kind: "style", description: "Charcoal and slate wardrobe with cool light; built for product and SaaS stories.", palette: ["#2b3238", "#5f6b75", "#c5ccd2"], templates: { female: "d7ad40ec97d4459a92b33398b57caf4e", male: "fbd03fc3603a4e3caff594f5743a1733" }, looks: 5, type: "look_pack" },
  { id: "healthcare", name: "Healthcare", kind: "role", description: "Scrubs, white coats and clinic settings for health, wellness and pharma.", palette: ["#2f6f8f", "#bfe0ea", "#f2f8fa"], templates: { female: "14f4070bd5a04eb6b1f82ae087cd0f30", male: "ce706bfa8556401e8c4401765102a455" }, looks: 5, type: "look_pack" },
  { id: "keynote-power-presenter", name: "Keynote Power Presenter", kind: "role", description: "On stage under keynote lighting — launches, announcements, big claims.", palette: ["#1a1a1f", "#7a4bd6", "#e8e2f7"], templates: { female: "b0cae4fbae384ab9ab9a8e73ba504be8", male: "71e84769162d4f4186563ad9e0fc45b8" }, looks: 5, type: "look_pack" },
  { id: "fitness", name: "Fitness", kind: "role", description: "Athletic wear in gyms and studios for fitness, nutrition and active brands.", palette: ["#2f3b2e", "#8fbf6a", "#e9f1e2"], templates: { female: "935ea0b7cdde4e6eb5a198a3d666f677", male: "daeb8b15c92a4acf9ffb437ba5534458" }, looks: 5, type: "look_pack" },
  { id: "automotive-dealership", name: "Automotive Dealership", kind: "role", description: "Showroom floors and service bays for dealerships and automotive services.", palette: ["#3a3f47", "#b5322f", "#e6e6e6"], templates: { female: "6f183d726933457c9035fc0aa4e9c0c3", male: "8595c78b466c4e51802731229c59b6e7" }, looks: 5, type: "look_pack" },
  { id: "business-casual", name: "Business Casual", kind: "style", description: "One outfit, two angles: smart-casual against a plain backdrop.", palette: ["#4d5a6b", "#c7b8a2", "#f1eee8"], templates: { female: "b30c83d99cec48e09c8f5b07ed8aa38c", male: "2dc326030e2e4471babcc9eda56131b6" }, looks: 2, type: "template" },
  { id: "podcast", name: "Podcast", kind: "role", description: "At the mic in a warm studio — interview and talk-show framing.", palette: ["#3b2a22", "#d98d4b", "#f4e6d6"], templates: { female: "00c49daa4eb94386a0c12508043bab17", male: "0e52ceafe4d5456fb83c1e39899ff76a" }, looks: 2, type: "template" },
];
