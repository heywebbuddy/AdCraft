...
## 18. Create an avatar (HeyGen digital twins and virtual characters)

Sidebar → Character studio → **Create an avatar** (`/characters?view=avatars`). Two cards, mirroring HeyGen's own "Create your first avatar":
